...
namespace UnitTests
{
    ...
    public class SetupTestSharedData
    {
        ...
        private void SetupSha3Cases()
        {
            ...
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputMessage = "", BitLength = 224 }).Returns("6b4e03423667dbb73b6e15454f0eb1abd4597f9a1b078e3f5b5a6bc7").SetName("SHA-3-224-0bits").SetCategory("SHA-3-224"));
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputMessage = "abc", BitLength = 224 }).Returns("e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf").SetName("SHA-3-224-24bits").SetCategory("SHA-3-224"));
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputMessage = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", BitLength = 224 }).Returns("8a24108b154ada21c9fd5574494479ba5c7e7ab76ef264ead0fcce33").SetName("SHA-3-224-448bits").SetCategory("SHA-3-224"));
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputMessage = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu", BitLength = 224 }).Returns("543e6868e1666c1a643630df77367ae5a62a85070a51c14cbf665cbc").SetName("SHA-3-224-896bits").SetCategory("SHA-3-224"));
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputMessage = OneMillionA, BitLength = 224 }).Returns("d69335b93325192e516a912e6d19a15cb51c6ed5c15243e7a7fd653c").SetName("SHA-3-224-AOneMillion").SetCategory("SHA-3-224"));
            Sha3TestDataValues.Add(new TestCaseData(new TestDataValues() { InputBytes = GigaByte, BitLength = 224 }).Returns("c6d66e77ae289566afb2ce39277752d6da2a3c46010f1e0a0970ff60").SetName("SHA-3-224-GigaByte of Data").SetCategory("SHA-3-224"));
